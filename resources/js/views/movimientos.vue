    ...
    <div class="row">
        ...
        >
          ...
          <option :value="item.num" v-for="(item,index) in cantidades" :key="index">{{item.num}}</option>
                ...
                <button
                    class="button"
                    @click="listar(dataPaginacion.currentPage)"
                >
                    ...
                    <thead>
                        <tr>
                            ...
                            <th
                                scope="col"
                                v-if="
                                    [1, 29, 21, 34].includes(parseInt(user_id))
                                "
                            >
                                eliminar
                            </th>
            ...
            >
                <ul class="pagination">
                    <li
                        class="page-item"
                        :disabled="dataPaginacion.currentPage == 1"
                    >
                        <a
                            class="page-link"
                            :class="
                                dataPaginacion.currentPage == 1 ? '' : 'cursor'
                            "
                            @click="
                    ...
                    <li
                        ...
                        class="page-item"
                        :class="
                            index + 1 == dataPaginacion.currentPage
                                ? 'active'
                                : ''
                        "
                    >
                    ...
                    <li class="page-item">
                        <a
                            class="page-link"
                            :class="
                                dataPaginacion.currentPage ==
                                dataPaginacion.cantidad
                                    ? ''
                                    : 'cursor'
                            "
                            @click="
    ...
    methods: {
        ...
        paginador(page) {
            if (
                ...
                page <=
                    this.dataPaginacion.limitPagina +
                        this.dataPaginacion.currentPage
            ) {
                return true;
            } else {
                return false;
