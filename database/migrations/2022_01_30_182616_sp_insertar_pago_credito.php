...
class SpInsertarPagoCredito extends Migration
{
    ...
    public function up()
    {
        ...
        begin
            insert into creditos_payments(credito_id, monto, descripcion, caja, created_by, created_at, updated_at)
            values(credito_id_p,monto_p,descripcion_p,caja_p,user_id_p,fecha, fecha);
            select @@identity id;
        END";
